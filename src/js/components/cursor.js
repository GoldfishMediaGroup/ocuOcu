...
function cursor() {
  ...
  //   floatingEffectStartIndex = Math.floor(10); // Количество элементов, которые ведут себя особым образом
  ...
  //   constructor(index = 0) {
  //     this.index = index;
  //     this.anglespeed = 0.08; // Скорость колебания в режиме "плавания"
  //     this.x = 0;
  //     this.y = 0;
